...
import time
from microrts.sl.utils import store
import microrts.settings as settings

new_base_dir = '~/Repository/uRTS/Jin_MicroRTS/MicroRTS_Git/'
base_dir = '~/'
base_dir = new_base_dir
tournament_dir = os.path.join(base_dir, "tournament_3/traces")
...
#1. load zip
#2. unzip xml
#3. parse gamestate from xml
#4. extract gamestate of player 1 and then store in Records
#5. store records to disk
